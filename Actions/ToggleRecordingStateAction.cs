...
{
    public class ToggleRecordingStateAction : PluginAction
    {
        // The name of the action
        public override string Name => "Start/Stop Recording";

        // A short description what the action can do
        public override string Description => "Toggles recording start/stop";
